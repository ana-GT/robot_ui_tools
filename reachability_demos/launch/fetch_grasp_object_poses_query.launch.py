...
def generate_launch_description():
    ...
    # markers
    rtu_yaml = load_yaml("task_ui", "config/fetch_object_placement_task.yaml")
    rtu_params = {"robot_task_ui_params": rtu_yaml}
    
    task_marker = Node(
        package='task_ui',
        executable='markers_get_grasp_object_poses_node',
        output='screen',
        parameters=[
    ...
    app_robot_task = Node(
        ...
        executable='simple_grasp_object_poses_solver',
        output='screen',
        parameters=[
