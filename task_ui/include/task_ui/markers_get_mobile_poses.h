...
class MarkersGetMobilePoses : public RobotTaskMarkers {

public:

  MarkersGetMobilePoses(const std::string &_server_name);
...
protected:
  ...
  void client_cb(rclcpp::Client<reachability_msgs::srv::GetMobilePoses>::SharedFuture _future);
  ...
  rclcpp::Client<reachability_msgs::srv::GetMobilePoses>::SharedPtr client_;
  std::shared_future<std::shared_ptr<reachability_msgs::srv::GetMobilePoses::Response>> client_result_;
